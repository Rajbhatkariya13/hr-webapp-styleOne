...
pw.println("<h3>Notification : Designation Deleted</h3>");
...
pw.println("<!-- right panel starts here -->");
pw.println("<div style='height:65vh;margin-left:105px;margin-right:5px;margin-botton:5px;margin-top:5px;padding:5px;border:1px solid black'>");
pw.println("<h3>Notification : Unable to delete designation</h3>");
pw.println("<b style='color:red'>"+daoException.getMessage()+"</b><br>");
pw.println("<form action='/styleone/designationsView'>");
pw.println("<button type='submit'>Ok</button>");
pw.println("</form>");
pw.println("</div>");
...
pw.println("<!-- left panel ends here -->");
pw.println("<!-- right panel starts here -->");
pw.println("<div style='height:65vh;margin-left:105px;margin-right:5px;margin-botton:5px;margin-top:5px;padding:5px;overflow:scroll;border:1px solid black'>");
